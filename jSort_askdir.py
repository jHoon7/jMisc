# This script renames JPEG images based on their date.
import os
import re
...
if __name__ == "__main__":
    while True:
        # Prompt the user to enter the directory containing the JPEG images
        directory_path = input("Enter the directory containing the JPEG images: ")
        ...
        # Ask the user if they want to process another directory
        another = input("Do you want to process another directory? (y/n): ").strip().lower()
        if another != 'y':
            break